...
§"Data Structures" above (and this file, of course) are the best examples
here of the sort of documentation I produce. Documentation generated by
[pdoc] from Python docstrings is found under [`.build/hdoc/`] after running
the top-level build/test script `Test`. (I chose pdoc because it's simple
